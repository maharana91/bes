...
public class XsipOrderEntryParam {
    ...
    @XmlElementRef(name = "Brokerage", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> brokerage;
    @XmlElementRef(name = "MandateID", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "XsipRegID", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Filler1", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filler1;
    @XmlElementRef(name = "Filler2", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filler2;
    @XmlElementRef(name = "Filler3", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filler3;
    @XmlElementRef(name = "Filler4", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filler4;
    @XmlElementRef(name = "Filler5", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> filler5;
    @XmlElementRef(name = "Filler6", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)

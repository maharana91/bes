...
/**
 * <p>Java class for SipOrder complex type.
 * 
 ...
 *         &lt;element name="NoOfInstallments" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "SipOrder", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", propOrder = {
    "clientCode",
    "dpc",
    "dpTxnMode",
    "euin",
...
public class SipOrder {
    ...
    @XmlElementRef(name = "DPTxnMode", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "FirstOrderFlag", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "FrequencyAllowed", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> frequencyAllowed;
    @XmlElementRef(name = "FrequencyType", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "InstallmentAmount", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> installmentAmount;
    @XmlElementRef(name = "InternalRefNo", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> internalRefNo;
    @XmlElementRef(name = "MemberCode", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> memberCode;
    @XmlElementRef(name = "NoOfInstallments", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> noOfInstallments;
    ...
    @XmlElementRef(name = "RegId", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SchemeCode", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> schemeCode;
    @XmlElementRef(name = "StartDate", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> startDate;
    @XmlElementRef(name = "SubberCode", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> subberCode;
    @XmlElementRef(name = "TransMode", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transMode;
    @XmlElementRef(name = "TransactionCode", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transactionCode;
    @XmlElementRef(name = "UniqueRefNo", namespace = "http://schemas.datacontract.org/2004/07/MFOrderService", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getNoOfInstallments() {
     ...
     *     
     */
    public void setNoOfInstallments(JAXBElement<String> value) {

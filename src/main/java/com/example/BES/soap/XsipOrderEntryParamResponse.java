...
public class XsipOrderEntryParamResponse {
    ...
    @XmlElementRef(name = "xsipOrderEntryParamResult", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> xsipOrderEntryParamResult;
     ...
     *     
     */
    public JAXBElement<String> getXsipOrderEntryParamResult() {
     ...
     *     
     */
    public void setXsipOrderEntryParamResult(JAXBElement<String> value) {

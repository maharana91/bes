...
public class OrderEntryParam {
    ...
    @XmlElementRef(name = "MobileNo", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mobileNo;
    @XmlElementRef(name = "EmailID", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)

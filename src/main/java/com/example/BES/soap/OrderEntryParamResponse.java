...
public class OrderEntryParamResponse {
    ...
    @XmlElementRef(name = "orderEntryParamResult", namespace = "http://bsestarmf.in/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> orderEntryParamResult;
     ...
     *     
     */
    public JAXBElement<String> getOrderEntryParamResult() {
     ...
     *     
     */
    public void setOrderEntryParamResult(JAXBElement<String> value) {
